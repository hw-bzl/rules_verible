#!/usr/bin/env bash
# Build the rules_verible release archive and emit release notes.
...
#
# Args:
#   $1: tag name (e.g. 0.2.0). Must match VERSION in version.bzl.
#
# Side effects:
#   Writes rules_verible-${TAG}.tar.gz to the current directory. This
...
ARCHIVE="rules_verible-${TAG}.tar.gz"
